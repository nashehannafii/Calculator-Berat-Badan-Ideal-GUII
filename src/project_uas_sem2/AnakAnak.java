 ...
 * @author user
 */
public class AnakAnak extends javax.swing.JFrame {
    ...
    private void isiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_isiActionPerformed
        String [] isi = {nama1.getText(), "Anak Anak", umur1.getText(), TB1.getText(), BB1.getText(), BBI1.getText() };
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AnakAnak.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
